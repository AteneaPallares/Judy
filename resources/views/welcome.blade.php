        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-xl-5">
                <div class="text-container">
                    ...
                    <p>Nos especializamos en la distribución de cualquier tipo de papel utilizado para el hogar y
                        empresa, desde la cartulina hasta el papel fotográfico .</p>
            ...
            <div class="row">
                <div class="col-lg-4 d-flex align-items-stretch">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="testimonial-text">Sinceramente felicito a esta distribuidora, ya que siempre
                                brinda
